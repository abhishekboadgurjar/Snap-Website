...
1. **Clone the repository**:
    ```bash
    git clone https://github.com/abhishekgurjarin/Snap-Website.git
    ```
...
You can check out the live demo of the Snap Website project [here](https://abhishekgurjarin.github.io/Snap-Website/).
## Screenshots
